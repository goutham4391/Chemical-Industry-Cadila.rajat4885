...
this.$prev.carousel_transition(!1).addClass('prev').css('transform','translate3d('+(percent-100)+'%,0,0)')}$active.carousel_transition(!1).css('transform','translate3d('+percent+'%, 0, 0)')}
